...
<script>
    ...
    export default {
        ...
        watch: {
            prefix: function () {
                this.$emit('input-changef', 'prefix', this.prefix);
            },
            suffix: function () {
                this.$emit('input-changef', 'suffix', this.suffix);
            },
            checksum: function () {
                this.$emit('input-changef', 'checksum', this.checksum);
            },
            threads: function () {
                this.$emit('input-changef', 'threads', this.threads);
            },
        },
    };
</script>
