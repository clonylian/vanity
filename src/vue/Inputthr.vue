...
<script>
    ...
    export default {
        ...
        watch: {
            prefix: function () {
                this.$emit('input-changethr', 'prefix', this.prefix);
            },
            suffix: function () {
                this.$emit('input-changethr', 'suffix', this.suffix);
            },
            checksum: function () {
                this.$emit('input-changethr', 'checksum', this.checksum);
            },
            threads: function () {
                this.$emit('input-changethr', 'threads', this.threads);
            },
        },
    };
</script>
