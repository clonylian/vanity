...
<script>
    ...
    export default {
        ...
        watch: {
            prefix: function () {
                this.$emit('input-changet', 'prefix', this.prefix);
            },
            suffix: function () {
                this.$emit('input-changet', 'suffix', this.suffix);
            },
            checksum: function () {
                this.$emit('input-changet', 'checksum', this.checksum);
            },
            threads: function () {
                this.$emit('input-changet', 'threads', this.threads);
            },
        },
    };
</script>
