...
<script>
    ...
    export default {
        ...
        watch: {
            prefix: function () {
                this.$emit('input-changey', 'prefix', this.prefix);
            },
            suffix: function () {
                this.$emit('input-changey', 'suffix', this.suffix);
            },
            checksum: function () {
                this.$emit('input-changey', 'checksum', this.checksum);
            },
            threads: function () {
                this.$emit('input-changey', 'threads', this.threads);
            },
        },
    };
</script>
